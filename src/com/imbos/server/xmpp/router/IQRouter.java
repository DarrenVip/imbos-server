...
import com.imbos.server.xmpp.handler.IQAuthHandler;
import com.imbos.server.xmpp.handler.IQHandler;
import com.imbos.server.xmpp.handler.IQMessageHandler;
import com.imbos.server.xmpp.handler.IQRegisterHandler;
import com.imbos.server.xmpp.handler.IQRosterHandler;
...
public class IQRouter {
    ...
    public IQRouter() {
        ...
        iqHandlers.add(new IQMessageHandler());
    }
